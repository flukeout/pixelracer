...
var tracks = ["noirjump.png","oval.png","superjump.png","twitter.png","ampersand.png","oval-8.png"];
...
race = {
  ...
  checkFinish: function(){
    ...
    for(var key in playerStats){
      ...
      if(player.mode != "finished"){
        finished = false;
      }
    }

    // if all the players are finished, then the race is over
  ...
  finishLap : function(id,message){
    ...
    if(this.mode == "racing" && player.mode == "racing") {
      ...
      if(player.laps > this.totallaps) {
        ...
        //Should send an event here.. BOB GOT FIRST PLACE!!!
  ...
  finishRace : function(){
    ...
    for(var key in playerStats){
      ...
      player.totalPoints = player.newPoints;
    }
